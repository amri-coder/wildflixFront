...
export class AllVideosComponent implements OnInit {
  ...
  videoUrl: string = 'https://www.youtube.com/embed/mX_7du3t1GY?list=RDmX_7du3t1GY';
  ...
  onCheckboxChange(event: any): void {
    const categories: FormArray = this.allVideoForm.get('categories') as FormArray;
  ...
  onFilterVideos(): void {
    ...
    if (categories.length > 0) {
      this.vidéoService.getVideosByCategories(categories).subscribe((result: video[]) => {
